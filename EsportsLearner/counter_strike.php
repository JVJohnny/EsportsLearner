...
$_SESSION["document"] = "counter_strike.php";
...
if(isset($_GET["acao"])){
    ...
    if (($_GET["acao"]) == "avaliar") {
        ...
        header("location: counter_strike.php");
    }
...
<body>
    ...
    <div class="container">
        ...
        <?php
					include "include/conecta.php";
					$sql = "select cod_videos, url_embed, categoria, titulo, media, cod_usuario from videos where categoria = 'Counter-Strike' order by media desc, cod_videos asc";
                        ...
                        <div class="col-md-6 col-lg-4 col-sm-12 col-xs-8 " >
                            ...
                            <div class="row ">
                                <div class="col-md-12">
                                    ...
                                    <form method="post" action="counter_strike.php?acao=avaliar&cod_videos=<?php echo $registro->cod_videos; ?>">
