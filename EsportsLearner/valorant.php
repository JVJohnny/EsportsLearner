...
$_SESSION["document"] = "valorant.php";
...
<body>
    ...
    <div class="container">
        ...
        <?php
					include "include/conecta.php";
					$sql = "select cod_videos, url_embed, categoria, titulo, media, cod_usuario from videos where categoria = 'Valorant' order by media desc, cod_videos asc";
                        ...
                        <div class="col-md-6 col-lg-4 col-sm-12 col-xs-8 " >
                            ...
                            <div class="row ">
                                <div class="col-md-12">
                                    ...
                                    <form method="post" action="valorant.php?acao=avaliar&cod_videos=<?php echo $registro->cod_videos; ?>">
